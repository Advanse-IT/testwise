  ...
  return (
    <PageWrapper>
            ...
            return (
              <Reveal key={i} delay={i*0.07}>
                <div className="card-accent p-8 h-full flex flex-col">
                  ...
                  <h3 className="text-title-md text-snow mb-2">{v.name}</h3>
      ...
      <section className="py-20 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-14 items-start">
          <Reveal>
            ...
            <h2 className="text-title-xl text-snow mb-5">Configured to your obligations — not a generic template.</h2>
      ...
      <section className="py-16 px-6 text-center max-w-xl mx-auto">
        <Reveal>
          <h2 className="text-title-lg text-snow mb-4">Not sure which configuration applies to your sector?</h2>
