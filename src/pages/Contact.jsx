...
export default function Contact() {
  usePageMeta({ title:'Contact', description:'Book a free discovery call with Testwise. We will map your QA environment and show you exactly what a bespoke autonomous pipeline would involve.', canonical:'/contact' })
